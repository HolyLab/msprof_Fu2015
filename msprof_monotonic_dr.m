...
%     relconc and relconcerr: n_unique_stimuli-by-n_cells matrices,
%       specifying the sensitivity of each cell to each unique stimulus.
%       The rows of these matrices should be in the order corresponding
%       to unique(stimlabel).
% and
